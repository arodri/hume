...
type NearestValueThreshold struct {
	BaseEvaluator
	Thresholder
...
func (nv *NearestValueThreshold) Evaluate(data map[string]float64, total int) Evaluation {
...
func (nv *NearestValueThreshold) Train(data map[string]float64, total int) error {
